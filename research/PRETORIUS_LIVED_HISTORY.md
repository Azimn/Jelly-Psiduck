...
Pretorius does not ingest the 271-record LoRA dataset as 271 invented life events. That material remains phenotype evidence. The seeded history keeps screen canon, archived self-description, phenotype evidence, actual project history, relationship history, and research history as distinct evidence classes. The persisted Memory.kind records that class, while the source artifact keeps record-level provenance.
